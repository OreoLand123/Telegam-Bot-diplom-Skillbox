...
from aiogram_dialog.widgets.kbd import StubScroll, ScrollingGroup, NumberedPager, SwitchTo, Back, Start
...
result_dialog = Dialog(
    ...
    Window(
        ...
        ScrollingGroup(NumberedPager(
            ...
            height=1,
            id="obj"),
        SwitchTo(Const("Get JSON object"),
                 id="json", state=ResultDialog.get_json_obj,
                 on_click=get_json),
        Start(Const("Back to main menu"),
