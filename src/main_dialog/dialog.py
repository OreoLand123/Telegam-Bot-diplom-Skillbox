...
main_dialog = Dialog(
    Window(
        ...
        Row(
            ...
            SwitchTo(Const("height"),
                     id="height",
                     state=MainDialog.choice_window,
                     on_click=get_filter_name),
            SwitchTo(Const("Custom"),
                     id="custom",
                     state=MainDialog.choice_window,
                     on_click=get_filter_name)
        ),
    ...
    Window(
        Format("Выберите что именно вы хотите запросить для фильтра {dialog_data[filter_name]}"),
        Row(
            SwitchTo(Const("people"),
                     id="people",
                     state=MainDialog.people_window,
                     on_click=get_param),
            SwitchTo(Const("starships"),
                     id="starships",
                     state=MainDialog.starships_window,
                     on_click=get_param),
            SwitchTo(Const("vehicles"),
                     id="vehicles",
                     state=MainDialog.vehicles_window,
                     on_click=get_param),
        ),
        Row(
            SwitchTo(Const("species"),
                     id="species",
                     state=MainDialog.species_window,
                     on_click=get_param),
            SwitchTo(Const("planets"),
                     id="planets",
    ...
    Window(
        Format("Выберете по какому полю фильтравать запрос для {dialog_data[param]}"),
        Column(
            SwitchTo(Const("cargo_capacity"),
                     id="cargo_capacity",
                     state=MainDialog.input_window,
                     on_click=get_arg_param),
            SwitchTo(Const("cost_in_credits"),
                     id="cost_in_credits",
                     state=MainDialog.input_window,
                     on_click=get_arg_param),
            SwitchTo(Const("hyperdrive_rating"),
                     id="hyperdrive_rating",
                     state=MainDialog.input_window,
                     on_click=get_arg_param),
            SwitchTo(Const("length"),
                     id="length",
                     state=MainDialog.input_window,
                     on_click=get_arg_param),
            SwitchTo(Const("passengers"),
                     id="passengers",
                     state=MainDialog.input_window,
                     on_click=get_arg_param),
    ...
    Window(
        ...
        Column(
            ...
            SwitchTo(Const("passengers"),
                     ...
                     state=MainDialog.input_window,
                     on_click=get_arg_param),
            SwitchTo(Const("max_atmosphering_speed"),
    ...
    Window(
        Format("Выберете по какому полю фильтравать запрос для {dialog_data[param]}"),
        Row(
            SwitchTo(Const("average_height"),
                     id="average_height",
                     state=MainDialog.input_window,
                     on_click=get_arg_param),
            SwitchTo(Const("average_lifespan"),
                     id="average_lifespan",
                     state=MainDialog.input_window,
                     on_click=get_arg_param),
    ...
    Window(
        Format("Выберете по какому полю фильтравать запрос для {dialog_data[param]}"),
        Column(
            SwitchTo(Const("diameter"),
                     id="diameter",
                     state=MainDialog.input_window,
                     on_click=get_arg_param),
            SwitchTo(Const("orbital_period"),
                     id="orbital_period",
                     state=MainDialog.input_window,
                     on_click=get_arg_param),
            SwitchTo(Const("population"),
                     id="population",
                     state=MainDialog.input_window,
                     on_click=get_arg_param),
            SwitchTo(Const("rotation_period"),
                     id="rotation_period",
                     state=MainDialog.input_window,
                     on_click=get_arg_param),
            SwitchTo(Const("surface_water"),
                     id="surface_water",
                     state=MainDialog.input_window,
                     on_click=get_arg_param),
    ...
    Window(
        ...
        Column(SwitchTo(Const("Back"), id="back_to_choice", state=MainDialog.choice_window)),
        MessageInput(input_message_value,
    ...
    Window(
        ...
        SwitchTo(Const("Back"),
                 state=MainDialog.input_window,
                 id="back_to_window1"),
        MessageInput(input_message_value_custom,
                     content_types=[ContentType.TEXT]),
    ...
    Window(
        ...
        MessageInput(input_message_count_value,
                     content_types=[ContentType.TEXT]),
        SwitchTo(Const("Back"),
                 state=MainDialog.input_window,
                 id="back_to_window_2"),
    ...
    Window(
        Format("Данные которые вы ввели:\n"
        ...
        Button(Const("Start"),
               id="start",
               on_click=go_to_result_dialog),
        SwitchTo(Const("Back ot choice"),
                 id="back_to_choice",
                 state=MainDialog.choice_window),
